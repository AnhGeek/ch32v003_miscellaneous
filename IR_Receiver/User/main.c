...
/*********************************************************************
 * @fn      GPIO_Interrupt_IR
 *
 * @brief   Initializes GPIOD.4
 *
 * @return  none
 */
void GPIO_Interrupt_IR()
{
    GPIO_InitTypeDef GPIO_InitStructure = {0};
    ...
    //Configuration for GPIO Input on D4
...
int main(void)
{
    ...
    //TIM1_PWMOut_Init( 100-1, 12-1, 50);
    TIM1_PWMOut_Init( 50000, 24-1, 5000);
    GPIO_Toggle_INIT();
...
void EXTI7_0_IRQHandler(void)
{
    ...
    {     
        if ( val == 0 ) 
        {
            ...
            ir[0] = 0;
            val = 1;
            EXTI->INTFR = EXTI_Line4;     /* Clear Flag */
            return;
        } else if (val <= 67)
        {
            ir[val] = TIM1->CNT; 
